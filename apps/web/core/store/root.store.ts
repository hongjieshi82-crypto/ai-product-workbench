...
import type { ICaseClusterStore } from "./case-cluster.store";
import { CaseClusterStore } from "./case-cluster.store";
...
export class CoreRootStore {
  ...
  constructor() {
    ...
    this.caseCluster = new CaseClusterStore();
