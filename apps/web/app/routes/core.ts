...
export const coreRoutes: RouteConfigEntry[] = [
  ...
  layout("./(all)/layout.tsx", [
    // Personal product manager workbench
    layout("./(all)/personal-workbench/layout.tsx", [
      route("workbench/:section?", "./(all)/personal-workbench/page.tsx"),
    ]),
    ...
    layout("./(all)/[workspaceSlug]/layout.tsx", [
      ...
      layout("./(all)/[workspaceSlug]/(projects)/layout.tsx", [
        ...
        layout("./(all)/[workspaceSlug]/(projects)/projects/(detail)/[projectId]/layout.tsx", [
          ...
          layout("./(all)/[workspaceSlug]/(projects)/projects/(detail)/[projectId]/case-clusters/layout.tsx", [
            route(
              ":workspaceSlug/projects/:projectId/case-clusters",
              "./(all)/[workspaceSlug]/(projects)/projects/(detail)/[projectId]/case-clusters/page.tsx"
            ),
          ]),
          // Project Issues List
